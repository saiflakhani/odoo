...
class ResumeParser(object):
    ...
    def __get_basic_details(self):
        cust_ent = utils.extract_entities_wih_custom_model(self.__text_raw)
        ...
        prof_summ = utils.extract_entity_sections_professional(self.__text_raw)
...
if __name__ == '__main__':
    resume = 'D:\\alka resume\Alka_Python_3_Years.pdf'
    data = ResumeParser(resume).get_extracted_data()
    # print(data)
    data = resume_result_wrapper(resume)
    # print(data)
